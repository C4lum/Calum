...
public class template extends GameEngine {
	// Main Function
	public static void main(String args[]) {
		// Warning: Only call createGame in this function
		// Create a new Lab3
		createGame(new template());
	}
	...
	public void updateLaser(double dt) {
		...
		if(laserPositionX==500|| laserPositionY==500||laserPositionX==0|| laserPositionY==0){
			laserActive = false;
		}
	}
